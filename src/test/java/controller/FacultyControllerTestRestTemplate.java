...
class FacultyControllerTestRestTemplate {
    ...
    @Test
    void testFilter() {
        var f1 = template.postForEntity("/faculty", new Faculty(null, "test_name1", "testcolor1"), Faculty.class).getBody();
        var f2 = template.postForEntity("/faculty", new Faculty(null, "test_name2", "testcolor2"), Faculty.class).getBody();
        var f3 = template.postForEntity("/faculty", new Faculty(null, "test_name3", "testcolor3"), Faculty.class).getBody();
